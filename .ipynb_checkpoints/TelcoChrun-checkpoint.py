...
##############################################################################################
# Adım 3:  Numerik ve kategorik değişkenlerin veri içindeki dağılımını
# gözlemleyiniz.
...
# Adım6: Eksik gözlem var mı inceleyiniz.
...
# Adım 1:  Sınıflandırma algoritmaları ile modeller kurup, accuracy skorlarını
# inceleyip. En iyi 4 modeli seçiniz.
y = df["Churn"]
